...
export default function ContactModal({
  ...
  // إعداد البيانات
  const phoneNumber = '0501234567'; // ← رقم الهاتف الخاص بك هنا
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle>Contact Us About:</DialogTitle>
        ...
        <div className="space-y-4">
          ...
          <div className="text-gray-700 dark:text-gray-300 space-y-1">
            <p><strong>Price:</strong> {formatPrice(carPrice)}</p>
            {year && <p><strong>Year:</strong> {year}</p>}
            {mileage && <p><strong>Mileage:</strong> {mileage.toLocaleString()} km</p>}
          </div>
