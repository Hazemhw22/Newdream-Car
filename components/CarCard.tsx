...
export default function CarCard({ car }: CarCardProps) {
  ...
  return (
    <>
      <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 relative">
        {/* Header Tags */}
        ...
        <div className="p-4">
          ...
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-gray-600 dark:text-gray-400">{car.brand}</span>
            {car.isHybrid && (
          ...
          {/* Car Name */}
          <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-3">{car.name}</h3>
          ...
          <div className="border-t border-gray-300 dark:border-gray-700 pt-4">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <div className="text-xs text-gray-500 dark:text-gray-400">From price before discounts</div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              <Button variant="outline" className="text-sm dark:border-gray-600 dark:text-gray-200">
                Car Details
              </Button>
              <Button 
