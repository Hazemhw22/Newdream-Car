...
export default function CarDetailsClientPage({ car }: Props) {
      ...
      <div className="lg:max-w-7xl lg:mx-auto lg:px-4 lg:py-8">
        ...
        <div className="lg:hidden px-4 py-6 space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
            <h2 className="text-lg font-bold mb-4 text-right">תכונות הרכב</h2>
          ...
          <div className="grid grid-cols-1 gap-4">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg">
              <div className="text-center">
                ...
                <div className="font-bold text-2xl text-green-600">חדש</div>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg text-center">
                <div className="text-gray-500 text-sm mb-2">אחריות יצרן</div>
                <div className="font-bold text-lg">3 שנים</div>
              </div>
              <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg text-center">
                <div className="text-gray-500 text-sm mb-2">זמינות</div>
                <div className="font-bold text-lg">מיידית</div>
              </div>
            </div>
          </div>
        ...
        <div className="hidden lg:grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
              <h2 className="text-xl font-bold mb-4 text-right">תכונות הרכב</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm">
                ...
                <div className="font-bold text-lg">חדש</div>
              </div>
              <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm">
                <div className="text-gray-500 text-sm">אחריות יצרן</div>
                <div className="font-bold text-lg">3 שנים</div>
              </div>
              <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm">
                <div className="text-gray-500 text-sm">זמינות</div>
                <div className="font-bold text-lg">מיידית</div>
              </div>
            </div>
            ...
            <div>
              <Tabs defaultValue="specs" className="w-full">
                <TabsList className="w-full grid grid-cols-3 h-12 text-sm">
                  ...
                  <TabsTrigger value="provider">פרטי יבואן</TabsTrigger>
                </TabsList>
                <TabsContent
                  value="specs"
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {car.images && car.images.length > 0 ? (
                      ...
                      <div className="text-center py-4 text-gray-500 col-span-2">
                        אין תמונות נוספות זמינות לרכב זה
                      </div>
                    )}
                  </div>
                </TabsContent>
                ...
                >
                  <div className="text-right">
                    <h3 className="font-bold text-lg mb-2">
                      {car.providers?.name || car.provider || "יבואן רשמי"}
                    </h3>
                    <p className="text-gray-600 dark:text-gray-400 mb-2">
                      {car.providers?.address || "כתובת היבואן"}
                    </p>
                    <p className="text-gray-600 dark:text-gray-400">
                      {car.providers?.phone || "טלפון: 03-1234567"}
                    </p>
                  </div>
                </TabsContent>
              </Tabs>
